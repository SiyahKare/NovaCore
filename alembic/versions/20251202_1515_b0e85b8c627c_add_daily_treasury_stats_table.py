"""add_daily_treasury_stats_table

Revision ID: b0e85b8c627c
Revises: 68c43ecf99b3
Create Date: 2025-12-02 15:15:21.877571
...
revision: str = 'b0e85b8c627c'
down_revision: Union[str, None] = '68c43ecf99b3'
...
def upgrade() -> None:
    ...
    # Create daily_treasury_stats table
    op.create_table('daily_treasury_stats',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('day', sa.Date(), nullable=False),
    sa.Column('limit_ncr', sa.Float(), nullable=False),
    sa.Column('issued_ncr', sa.Float(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_daily_treasury_stats_day'), 'daily_treasury_stats', ['day'], unique=True)
...
def downgrade() -> None:
    ...
    # Drop daily_treasury_stats table
    op.drop_index(op.f('ix_daily_treasury_stats_day'), table_name='daily_treasury_stats')
    op.drop_table('daily_treasury_stats')
    # ### end Alembic commands ###
