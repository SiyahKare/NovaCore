#!/bin/bash
# EC2 Docker Full Stack Deployment Script
# Bu script EC2'de çalıştırılmalı

set -e

echo "🐳 NovaCore Full Stack Docker Deployment (EC2)"
echo "=============================================="
echo ""
...
if [ ! -f "docker-compose.full.yml" ]; then
    echo -e "${RED}❌ docker-compose.full.yml bulunamadı!${NC}"
    echo -e "${YELLOW}   Lütfen proje root dizininde çalıştırın.${NC}"
    exit 1
fi
